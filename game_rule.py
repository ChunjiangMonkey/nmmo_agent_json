...
ITEM_TABLE = {
    "Spear": {
        "type": "Weapon",
        "function": "Increasing Melee attack",
        "acquisition_method": "Harvesting Tree",
        "skill": "Melee",
    },
    "Bow": {
        "type": "Weapon",
        "function": "Increasing Range attack",
        "acquisition_method": "Harvesting Crystal",
        "skill": "Range",
    },
    "Wand": {
        "type": "Weapon",
        "function": "Increasing Mage attack",
        "acquisition_method": "Harvesting Ore",
        "skill": "Mage",
    },
    "Whetstone": {
        "type": "Ammunition",
    ...
    "Hat": {
        "type": "Armor",
        "function": "Increasing defense",
        "body_part": "Hat",
        "acquisition_method": "Killing other entities",
        "skill": "Any",
    },
    "Top": {
        "type": "Armor",
    ...
    "Rod": {
        "type": "Tool",
        "function": "Increasing Fish harvest yield",
        "acquisition_method": "Killing other entities",
        "skill": "Fishing",
    },
    "Gloves": {
        "type": "Tool",
        "function": "Increasing Herb harvest yield",
        "acquisition_method": "Killing other entities",
        "skill": "Herbalism",
    },
    "Axe": {
        "type": "Tool",
        "function": "Increasing Tree harvest yield",
        "acquisition_method": "Killing other entities",
        "skill": "Carving",
    },
    "Pickaxe": {
        "type": "Tool",
        "function": "Increasing Ore harvest yield",
        "acquisition_method": "Killing other entities",
        "skill": "Prospecting",
    },
    "Chisel": {
        "type": "Tool",
        "function": "Increasing Crystal harvest yield",
        "acquisition_method": "Killing other entities",
        "skill": "Alchemy",
    },
    "Ration": {
...
SKILL_TABLE = {
    "Melee": {
        ...
        "weapons": "Spear",
        "ammunition": "Whetstone",
        "improvement_method": "Attacking other entities with Melee style",
    },
    "Range": {
        "combat_style": "Range",
        "weapons": "Bow",
        "ammunition": "Arrow",
        "improvement_method": "Attacking other entities with Range style",
    },
    "Mage": {
        "combat_style": "Mage",
        "weapons": "Wand",
        "ammunition": "Runes",
        "improvement_method": "Attacking other entities with Mage style",
    },
    "Fishing": {
        "resource": "Fish",
        "tool": "Rod",
        "improvement_method": "Harvesting Fish",
    },
    "Herbalism": {
        "resource": "Herb",
        "tool": "Gloves",
        "improvement_method": "Harvesting Herb",
    },
    "Carving": {
        "resource": "Tree",
        "tool": "Axe",
        "improvement_method": "Harvesting Tree",
    },
    "Prospecting": {
        "resource": "Ore",
        "tool": "Pickaxe",
        "improvement_method": "Harvesting Ore",
    },
    "Alchemy": {
        "resource": "Crystal",
        "tool": "Chisel",
        "improvement_method": "Harvesting Crystal",
    },
}
